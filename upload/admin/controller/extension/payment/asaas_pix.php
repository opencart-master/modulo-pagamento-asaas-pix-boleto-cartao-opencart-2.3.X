...
class ControllerExtensionPaymentAsaasPix extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/asaas_pix', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/asaas_pix', 'token=' . $this->session->data['token'], true);

		$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=payment', true);

		$data['webhook'] = $this->url->link('extension/payment/asaas_pix/webhook', 'token=' . $this->session->data['token'], true);
